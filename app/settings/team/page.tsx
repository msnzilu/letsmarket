...
export default function TeamPage() {
    ...
    return (
        <div className="space-y-6">
                ...
                <div className="flex gap-4">
                    <div className="flex-1 relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-brand-primary focus:outline-none"
                        />
                    </div>
            ...
            <div className="bg-brand-secondary-light p-4 rounded-lg flex gap-3">
