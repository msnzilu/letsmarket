        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
                <Card className="p-6 text-center">
                    ...
                    <a href="mailto:hello@psychanalyze.com" className="text-purple-600 hover:underline">
                        hello@psychanalyze.com
                    </a>
                </Card>
                <Card className="p-6 text-center">
                    <MessageSquare className="w-8 h-8 mx-auto text-blue-600 mb-3" />
